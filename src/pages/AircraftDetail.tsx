                ...
                {!generatedReport ? (
                  ...
                  <div className="space-y-4">
                    ...
                    <Alert className="border-primary/30 bg-primary/5">
                      ...
                      <AlertDescription>
                        This report is generated by AI based on available aircraft data. While highly accurate, final decision-making and approval should be conducted by qualified maintenance personnel and aviation engineers. Human review is strongly recommended.
                      </AlertDescription>
                    </Alert>
                ...
                <div className="space-y-6">
                  <DialogHeader>
                    <DialogTitle className="text-2xl flex items-center gap-3">
                      ...
                      {selectedWarning.system} Warning Details
                    </DialogTitle>
                    <DialogDescription>
                      AI-powered analysis and recommended actions for warning ID: {selectedWarning.id}
                    </DialogDescription>
                  </DialogHeader>

                  {/* AI Analysis Disclaimer */}
                  <div className="bg-muted/50 border border-muted-foreground/20 rounded-lg p-4 flex items-start gap-3">
                    <Info className="h-5 w-5 text-muted-foreground mt-0.5 flex-shrink-0" />
                    <div className="text-sm text-muted-foreground">
                      <strong className="text-foreground">AI-Powered Analysis:</strong> This assessment is generated by AeroSense AI based on sensor data and historical patterns. While highly accurate, final decision-making and approval should be conducted by qualified maintenance personnel and aviation engineers.
                    </div>
                  </div>
                  ...
                  <Card className="border-warning/30 bg-warning/5">
                    <CardContent className="p-6 space-y-4">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          <Badge variant={getSeverityColor(selectedWarning.severity) as any} className="uppercase">
                            {selectedWarning.severity} Priority
                          </Badge>
                          <Badge variant="outline">{selectedWarning.status}</Badge>
                        </div>
                        <div className="text-sm text-muted-foreground">
                          Detected: {selectedWarning.detectedDate}
                        </div>
                      </div>

                      <div>
                        <h4 className="font-semibold text-foreground mb-2">Description</h4>
                        <p className="text-muted-foreground">{selectedWarning.description}</p>
                      </div>

                      <div>
                        <h4 className="font-semibold text-foreground mb-2">Required Action</h4>
                        <p className="text-muted-foreground">{selectedWarning.action}</p>
                      </div>
                    </CardContent>
                  </Card>
                  ...
                  <div className="grid gap-4">
                    ...
                    <Card className="bg-card/60 backdrop-blur-sm">
                      ...
                      <CardContent className="space-y-3">
                        <div>
                          <p className="text-sm font-medium text-foreground mb-2">Primary Factors:</p>
                          <ul className="space-y-2 text-sm text-muted-foreground list-disc list-inside">
                            <li>Component wear and tear from {aircraft.flightHours.toLocaleString()} flight hours</li>
                            <li>Environmental stress factors during high-altitude operations</li>
                            <li>Normal degradation patterns consistent with {aircraft.cycles.toLocaleString()} flight cycles</li>
                          </ul>
                        </div>
                        <div>
                          <p className="text-sm font-medium text-foreground mb-2">Contributing Factors:</p>
                          <ul className="space-y-2 text-sm text-muted-foreground list-disc list-inside">
                            <li>Recent weather conditions at operating locations</li>
                            <li>Increased operational frequency in past 30 days</li>
                            <li>Component approaching scheduled replacement interval</li>
                          </ul>
                        </div>
                      </CardContent>
                    </Card>
                    ...
                    <Card className="bg-card/60 backdrop-blur-sm">
                      ...
                      <CardContent className="space-y-4">
                        <div className="grid grid-cols-2 gap-4">
                          <div>
                            <p className="text-xs text-muted-foreground mb-1">Affected System</p>
                            <p className="text-sm font-semibold text-foreground">{selectedWarning.system}</p>
                          </div>
                          <div>
                            <p className="text-xs text-muted-foreground mb-1">Component Location</p>
                            <p className="text-sm font-semibold text-foreground">Primary System Bay 2</p>
                          </div>
                          <div>
                            <p className="text-xs text-muted-foreground mb-1">Part Number</p>
                            <p className="text-sm font-semibold text-foreground">PN-{selectedWarning.id.split('-')[1]}-A</p>
                          </div>
                          <div>
                            <p className="text-xs text-muted-foreground mb-1">Serial Number</p>
                            <p className="text-sm font-semibold text-foreground">SN-{aircraft.serialNumber.split('-')[1]}{selectedWarning.id.split('-')[1]}</p>
                          </div>
                        </div>
                        <div>
                          <p className="text-xs text-muted-foreground mb-2">Related Components</p>
                          <div className="flex flex-wrap gap-2">
                            <Badge variant="outline">Primary Unit</Badge>
                            <Badge variant="outline">Backup System</Badge>
                            <Badge variant="outline">Control Module</Badge>
                            <Badge variant="outline">Sensor Array</Badge>
                          </div>
                        </div>
                      </CardContent>
                    </Card>
                    ...
                    <Card className="bg-card/60 backdrop-blur-sm">
                      ...
                      <CardContent className="space-y-3">
                        <div>
                          <p className="text-sm font-medium text-foreground mb-2">Operational Impact:</p>
                          <p className="text-sm text-muted-foreground">
                            {selectedWarning.severity === 'high' 
                              ? 'Aircraft grounded until issue is resolved. Immediate maintenance required before return to service.'
                              : selectedWarning.severity === 'medium'
                              ? 'Aircraft may continue limited operations with restrictions. Maintenance required within 48 hours.'
                              : 'Minimal operational impact. Can be addressed during next scheduled maintenance window.'}
                          </p>
                        </div>
                        <div>
                          <p className="text-sm font-medium text-foreground mb-2">Safety Considerations:</p>
                          <p className="text-sm text-muted-foreground">
                            Component redundancy ensures safe operation. However, monitoring and timely maintenance are critical to prevent potential escalation to higher severity.
                          </p>
                        </div>
                        <div>
                          <p className="text-sm font-medium text-foreground mb-2">Estimated Downtime:</p>
                          <p className="text-sm text-muted-foreground">
                            {selectedWarning.severity === 'high' ? '12-24 hours' : selectedWarning.severity === 'medium' ? '4-8 hours' : '2-4 hours'} for complete inspection and resolution
                          </p>
                        </div>
                      </CardContent>
                    </Card>
                    ...
                    <Card className="bg-primary/10 border-primary/30">
                      ...
                      <CardContent className="space-y-3">
                        <div>
                          <p className="text-sm font-medium text-foreground mb-2">Immediate Steps:</p>
                          <ol className="space-y-2 text-sm text-muted-foreground list-decimal list-inside">
                            <li>Conduct visual inspection of affected system and components</li>
                            <li>Review recent flight data logs for anomaly patterns</li>
                            <li>Verify readings with calibrated backup instruments</li>
                            <li>Document all findings in maintenance log system</li>
                          </ol>
                        </div>
                        <div>
                          <p className="text-sm font-medium text-foreground mb-2">Maintenance Procedures:</p>
                          <ol className="space-y-2 text-sm text-muted-foreground list-decimal list-inside">
                            <li>Follow AMM (Aircraft Maintenance Manual) Chapter {Math.floor(Math.random() * 50) + 20}-{Math.floor(Math.random() * 90) + 10}</li>
                            <li>Perform component replacement if wear exceeds tolerance limits</li>
                            <li>Conduct functional test after repairs</li>
                            <li>Update aircraft technical log and certification records</li>
                          </ol>
                        </div>
                        <div>
                          <p className="text-sm font-medium text-foreground mb-2">Required Personnel:</p>
                          <div className="flex flex-wrap gap-2">
                            <Badge variant="outline">Licensed Aircraft Engineer</Badge>
                            <Badge variant="outline">System Specialist</Badge>
                    ...
                    <Card className="bg-card/60 backdrop-blur-sm">
                      ...
                      <CardContent className="space-y-3">
                        <div>
                          <p className="text-sm font-medium text-foreground mb-2">Similar Warnings:</p>
                          <p className="text-sm text-muted-foreground">
                            This aircraft has experienced {Math.floor(Math.random() * 3) + 1} similar warnings in the past 12 months, all resolved successfully without operational impact.
                          </p>
                        </div>
                        <div>
                          <p className="text-sm font-medium text-foreground mb-2">Fleet-Wide Analysis:</p>
                          <p className="text-sm text-muted-foreground">
                            Across the fleet of {aircraft.model}, this type of warning occurs in approximately {Math.floor(Math.random() * 15) + 5}% of aircraft at similar flight hour intervals.
                          </p>
                        </div>
                        <div>
                          <p className="text-sm font-medium text-foreground mb-2">Last Related Maintenance:</p>
                          <p className="text-sm text-muted-foreground">
                            {aircraft.lastInspection} - Routine inspection of {selectedWarning.system} completed with no issues reported.
                          </p>
                        </div>
                      </CardContent>
                    </Card>
